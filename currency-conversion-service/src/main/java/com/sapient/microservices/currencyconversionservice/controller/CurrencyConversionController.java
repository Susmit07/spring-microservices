package com.sapient.microservices.currencyconversionservice.controller;
...
import com.sapient.microservices.currencyconversionservice.feign.CurrencyExchangeServiceProxy;
...
public class CurrencyConversionController {
	...
	(@PathVariable String from, @PathVariable String to, @PathVariable BigDecimal quantity) {
		...
		// Create a map which will store all the URI variables coming from the currency-exchange service.
		Map<String, String> uriVariables = new HashMap<>();
		uriVariables.put("from", from);
		uriVariables.put("to", to);
		// Accept the response from currency exchange service.
